...
public class BDDOperationsTest {
  ...
  public void testSupport() {
    assertThat(this.bddVerum.support()).isEqualTo(new TreeSet<Object>());
    assertThat(this.bddFalsum.support()).isEqualTo(new TreeSet<Object>());
    assertThat(this.bddPosLit.support()).isEqualTo(new TreeSet<Variable>(Collections.singletonList(this.f.variable("A"))));
    assertThat(this.bddNegLit.support()).isEqualTo(new TreeSet<Variable>(Collections.singletonList(this.f.variable("A"))));
    assertThat(this.bddImpl.support()).isEqualTo(new TreeSet<Variable>(Arrays.asList(this.f.variable("A"), this.f.variable("B"))));
    assertThat(this.bddEquiv.support()).isEqualTo(new TreeSet<Variable>(Arrays.asList(this.f.variable("A"), this.f.variable("B"))));
    assertThat(this.bddOr.support()).isEqualTo(new TreeSet<Variable>(Arrays.asList(this.f.variable("A"), this.f.variable("B"), this.f.variable("C"))));
    assertThat(this.bddAnd.support()).isEqualTo(new TreeSet<Variable>(Arrays.asList(this.f.variable("A"), this.f.variable("B"), this.f.variable("C"))));
  }
  ...
  public void testVariableProfil() {
    ...
    final Map.Entry<Variable, Integer> a0 = new AbstractMap.SimpleEntry<Variable, Integer>(a, 0);
    final Map.Entry<Variable, Integer> a1 = new AbstractMap.SimpleEntry<Variable, Integer>(a, 1);
    final Map.Entry<Variable, Integer> b0 = new AbstractMap.SimpleEntry<Variable, Integer>(b, 0);
    final Map.Entry<Variable, Integer> b1 = new AbstractMap.SimpleEntry<Variable, Integer>(b, 1);
    final Map.Entry<Variable, Integer> b2 = new AbstractMap.SimpleEntry<Variable, Integer>(b, 2);
    final Map.Entry<Variable, Integer> c0 = new AbstractMap.SimpleEntry<Variable, Integer>(c, 0);
    final Map.Entry<Variable, Integer> c1 = new AbstractMap.SimpleEntry<Variable, Integer>(c, 1);
    assertThat(this.bddVerum.variableProfile().entrySet()).containsExactly(a0, b0, c0);
    assertThat(this.bddFalsum.variableProfile().entrySet()).containsExactly(a0, b0, c0);
    assertThat(this.bddPosLit.variableProfile().entrySet()).containsExactly(a1, b0, c0);
    assertThat(this.bddNegLit.variableProfile().entrySet()).containsExactly(a1, b0, c0);
    assertThat(this.bddImpl.variableProfile().entrySet()).containsExactly(a1, b1, c0);
    assertThat(this.bddEquiv.variableProfile().entrySet()).containsExactly(a1, b2, c0);
    assertThat(this.bddOr.variableProfile().entrySet()).containsExactly(a1, b1, c1);
    assertThat(this.bddAnd.variableProfile().entrySet()).containsExactly(a1, b1, c1);
  }
}
