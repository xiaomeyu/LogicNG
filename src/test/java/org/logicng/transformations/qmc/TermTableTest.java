...
public class TermTableTest {
  ...
  public void testSubset() {
    final Vector<Boolean> vec1 = new Vector<Boolean>(Arrays.asList(true, true, false, false, true));
    final Vector<Boolean> vec2 = new Vector<Boolean>(Arrays.asList(true, true, false, false, true));
    final Vector<Boolean> vec3 = new Vector<Boolean>(Arrays.asList(true, false, false, false, false));
    final Vector<Boolean> vec4 = new Vector<Boolean>(Arrays.asList(true, true, true, false, true));
