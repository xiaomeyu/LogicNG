...
public final class BDD {
  ...
  public boolean equals(final Object o) {
    ...
    final BDD bdd = (BDD) o;
    if (this.index != bdd.index) return false;
    return this.factory != null ? this.factory.equals(bdd.factory) : bdd.factory == null;
  }

  @Override
  public int hashCode() {
    int result = this.index;
    result = 31 * result + (this.factory != null ? this.factory.hashCode() : 0);
    return result;
  }
