...
public class ForceOrdering implements VariableOrderingProvider {
  ...
  public List<Variable> getOrder(final Formula formula) {
    ...
    final Map<Variable, HypergraphNode<Variable>> nodes = new HashMap<Variable, HypergraphNode<Variable>>();
  ...
  private List<Variable> force(final Formula formula, final Hypergraph<Variable> hypergraph,
    ...
    do {
      ...
      final LinkedHashMap<HypergraphNode<Variable>, Double> newLocations = new LinkedHashMap<HypergraphNode<Variable>, Double>();
      for (final HypergraphNode<Variable> node : hypergraph.nodes())
  ...
  private LinkedHashMap<HypergraphNode<Variable>, Integer> createInitialOrdering(final Formula formula, final Map<Variable, HypergraphNode<Variable>> nodes) {
    final LinkedHashMap<HypergraphNode<Variable>, Integer> initialOrdering = new LinkedHashMap<HypergraphNode<Variable>, Integer>();
  ...
  private LinkedHashMap<HypergraphNode<Variable>, Integer> orderingFromTentativeNewLocations(final LinkedHashMap<HypergraphNode<Variable>, Double> newLocations) {
    final LinkedHashMap<HypergraphNode<Variable>, Integer> ordering = new LinkedHashMap<HypergraphNode<Variable>, Integer>();
    final List<Map.Entry<HypergraphNode<Variable>, Double>> list = new ArrayList<Map.Entry<HypergraphNode<Variable>, Double>>(newLocations.entrySet());
