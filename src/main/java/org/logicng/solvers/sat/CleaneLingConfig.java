...
public final class CleaneLingConfig extends Configuration {
  ...
  public String toString() {
    final StringBuilder sb = new StringBuilder("CleaneLingConfig{").append(String.format("%n"));
    sb.append("blockedClauseElimination=").append(this.block).append(String.format("%n"));
    sb.append("blockedClauseEliminationWait=").append(this.blkwait).append(String.format("%n"));
    sb.append("blockedClauseEliminationRTC=").append(this.blkrtc).append(String.format("%n"));
    sb.append("boost=").append(this.boost).append(String.format("%n"));
    sb.append("bwClauseLim=").append(this.bwclslim).append(String.format("%n"));
    sb.append("bwOccurrenceLim=").append(this.bwocclim).append(String.format("%n"));
    sb.append("clauseBumping=").append(this.cbump).append(String.format("%n"));
    sb.append("distillation=").append(this.distill).append(String.format("%n"));
    sb.append("bvElim=").append(this.elim).append(String.format("%n"));
    sb.append("bvElimRTC=").append(this.elmrtc).append(String.format("%n"));
    sb.append("bvElimOccurrenceLim=").append(this.elmocclim).append(String.format("%n"));
    sb.append("bvElimPivotOccurrenceLimOneSided=").append(this.elmpocclim1).append(String.format("%n"));
    sb.append("bvElimPivotOccurrenceLimTwoSided=").append(this.elmpocclim2).append(String.format("%n"));
    sb.append("bvElimClauseLim=").append(this.elmclslim).append(String.format("%n"));
    sb.append("gluered=").append(this.gluered).append(String.format("%n"));
    sb.append("glueKeep=").append(this.gluekeep).append(String.format("%n"));
    sb.append("glueUpdate=").append(this.glueupdate).append(String.format("%n"));
    sb.append("iterationSimplificationDelay=").append(this.itsimpdel).append(String.format("%n"));
    sb.append("plain=").append(this.plain).append(String.format("%n"));
    sb.append("restart=").append(this.restart).append(String.format("%n"));
    sb.append("restartInterval=").append(this.restartint).append(String.format("%n"));
    sb.append("reductionInterval=").append(this.redinit).append(String.format("%n"));
    sb.append("reductionIntervalInc=").append(this.redinc).append(String.format("%n"));
    sb.append("reuseTrail=").append(this.reusetrail).append(String.format("%n"));
    sb.append("simpSteps=").append(this.simpint).append(String.format("%n"));
    sb.append("simpGeomIncrease=").append(this.simpgeom).append(String.format("%n"));
    sb.append("sizePenalty=").append(this.sizepen).append(String.format("%n"));
    sb.append("sizeMaxPenalty=").append(this.sizemaxpen).append(String.format("%n"));
    sb.append("searchInterval=").append(this.searchint).append(String.format("%n"));
    sb.append("searchFirst=").append(this.searchfirst).append(String.format("%n"));
    sb.append("scoreIncrementFactor=").append(this.scincfact).append(String.format("%n"));
    sb.append("stepsLim=").append(this.stepslim).append(String.format("%n"));
